...
response = post("https://id.twitch.tv/oauth2/token?client_id=w7r7cmzkm0etx41ula5aq00oatzc4c&client_secret="+os.environ.get("MY_CLIENT_SECRET")+"&grant_type=client_credentials")
