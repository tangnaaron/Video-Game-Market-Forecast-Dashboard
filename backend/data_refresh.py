...
response = post(f'https://id.twitch.tv/oauth2/token?client_id=w7r7cmzkm0etx41ula5aq00oatzc4c&client_secret={os.getenv('CLIENT_SECRET')}&grant_type=client_credentials')
print(response.json())
